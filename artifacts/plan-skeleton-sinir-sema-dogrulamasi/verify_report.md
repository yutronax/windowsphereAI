...
[2m16:35:04[22m [33m[1m[vite][22m[39m [33mwarning: `esbuild` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `oxc` instead.[39m
...
[vite:react-babel] We recommend switching to `@vitejs/plugin-react-oxc` for improved performance. More information at https://vite.dev/rolldown
 ...
 Test Files  6 passed (6)
      Tests  96 passed (96)
   Start at  16:35:04
   Duration  4.49s (transform 977ms, setup 5.93s, import 1.10s, tests 1.66s, environment 12.10s)
