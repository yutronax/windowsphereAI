...
[2m16:24:54[22m [33m[1m[vite][22m[39m [33mwarning: `esbuild` option was specified by "vite:react-babel" plugin. This option is deprecated, please use `oxc` instead.[39m
...
[vite:react-babel] We recommend switching to `@vitejs/plugin-react-oxc` for improved performance. More information at https://vite.dev/rolldown
 ...
 Test Files  5 passed (5)
      Tests  77 passed (77)
   Start at  16:24:54
   Duration  2.00s (transform 484ms, setup 1.75s, import 548ms, tests 976ms, environment 3.64s)
